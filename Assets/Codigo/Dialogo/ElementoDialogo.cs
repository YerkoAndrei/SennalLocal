...
public class ElementoDialogo
{
    ...
    // Diálogo normal
    public static ElementoDialogo CrearDiálogo(Personajes personaje, string texto, Rutas ruta, NivelEstrés nivelEstrés = NivelEstrés.pausa, Animaciones animación = Animaciones.nada)
    {
