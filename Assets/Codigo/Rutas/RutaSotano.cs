...
public class RutaSotano : InterfazRuta
{
    ...
    private ElementoDialogo CrearSótano_3()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "sotano3_5", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "sotano3_6", ruta),
    ...
    private ElementoDialogo CrearSótano_4()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "sotano4_8", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "sotano4_9", ruta),
