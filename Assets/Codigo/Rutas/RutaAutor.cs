...
public class RutaAutor : InterfazRuta
{
    ...
    private ElementoDialogo CrearAutor_1()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_4", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_5", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_6", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_7", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_8", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_9", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_10", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_11", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_12", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_13", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_14", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_15", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_20", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_21", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_24", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_25", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "autor1_26", ruta),
