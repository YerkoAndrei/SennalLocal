...
public class RutaCaza : InterfazRuta
{
    ...
    private ElementoDialogo CrearCaza_1()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_9", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "caza1_10", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_11", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "caza1_12", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_13", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_14", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_15", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_16", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_17", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "caza1_18", ruta),
