...
public class RutaOperador : InterfazRuta
{
    ...
    public ElementoDialogo CrearOperador_0()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador0_12", ruta),
    ...
    private ElementoDialogo CrearOperador_4()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador4_3", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador4_6", ruta),
    ...
    private ElementoDialogo CrearOperador_7()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador7_23", ruta),
    ...
    private ElementoDialogo CrearOperador_8()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador8_5", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador8_12", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador8_13", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador8_20", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "operador8_21", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador8_22", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador8_23", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador8_24", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador8_25", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador8_26", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador8_27", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador8_28", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador8_29", ruta),
    ...
    private ElementoDialogo CrearOperador_9_1()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_9_1_1", ruta),
    ...
    private ElementoDialogo CrearOperador_9_2()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_9_2_3", ruta),
    ...
    private ElementoDialogo CrearOperador_10()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_0", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "operador_10_1", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_2", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_3", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_7", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_14", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_15", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.sobreviviente, "operador_10_25", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "operador_10_26", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_27", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador_10_28", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador_10_29", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador_10_30", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_31", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_32", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_33", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_34", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.monstruo, "operador_10_35", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_36", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "operador_10_37", ruta),
