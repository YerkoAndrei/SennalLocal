...
public class RutaUsuario : InterfazRuta
{
    ...
    public ElementoDialogo CrearBifurcación_usuario_0()
    {
        ...
        listaOpciones.Add(new ElementoOpcion("opcion_usuario0_0", CrearUsuario_2()[0]));
        listaOpciones.Add(new ElementoOpcion("opcion_usuario0_1", CrearUsuario_3()[0]));

        // Opción limitada
        if (SistemaMemoria.ObtenerRespuestaClave(RespuestasClave.peligroExterior))
            listaOpciones.Add(new ElementoOpcion("opcion_usuario0_2", monstruo.CrearMonstruo_1()[0]));
    ...
    public ElementoDialogo CrearBifurcación_usuario_1()
    {
        // Preguntas
        var listaOpciones = new List<ElementoOpcion>();
        listaOpciones.Add(new ElementoOpcion("opcion_usuario1_0", CrearUsuario_4()[0]));
        listaOpciones.Add(new ElementoOpcion("opcion_usuario1_2", CrearUsuario_6()[0]));

        // Opción limitada
        if(SistemaMemoria.ObtenerRespuestaClave(RespuestasClave.encendedorEncontrado))
            listaOpciones.Add(new ElementoOpcion("opcion_usuario1_1", CrearUsuario_5()[0]));
    ...
    public ElementoDialogo CrearBifurcación_usuario_2()
    {
        // Preguntas
        var listaOpciones = new List<ElementoOpcion>();
        listaOpciones.Add(new ElementoOpcion("opcion_usuario2_0", CrearUsuario_10()[0]));
        listaOpciones.Add(new ElementoOpcion("opcion_usuario2_1", CrearUsuario_11()[0]));
        listaOpciones.Add(new ElementoOpcion("opcion_usuario2_2", CrearUsuario_12()[0]));
    ...
    public ElementoDialogo CrearBifurcación_usuario_3()
    {
        // Preguntas
        var listaOpciones = new List<ElementoOpcion>();
        listaOpciones.Add(new ElementoOpcion("opcion_usuario3_0", CrearUsuario_14()[0]));
        listaOpciones.Add(new ElementoOpcion("opcion_usuario3_1", CrearUsuario_15()[0]));

        // Opción limitada
        if (SistemaMemoria.ObtenerRespuestaClave(RespuestasClave.llaveComputador))
            listaOpciones.Add(new ElementoOpcion("opcion_usuario3_2", CrearUsuario_18()[0]));
    ...
    public ElementoDialogo[] CrearUsuario_0()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 0", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_1()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 1", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_2()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 2", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_3()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 3", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_4()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 4", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_5()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 5", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_6()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 6", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_7()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 7", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_8()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 8", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_9()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 9", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_10()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 10", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_11()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 11", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_12()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 12", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_13()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 13", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_14()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 14", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_15()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 15", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_16()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 16", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_17()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 17", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_18()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 18", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_19_1()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 19.1", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_19_2()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 19.2", ruta));
    ...
    public ElementoDialogo[] CrearUsuario_20()
    {
        ...
        // Diálogos
        listaDiálogos.Add(ElementoDialogo.CrearDiálogo(Personajes.usuario, "USUARIO 20", ruta));
