...
public class RutaUsuario : InterfazRuta
{
    ...
    private ElementoDialogo CrearUsuario_16()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_10", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_13", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_32", ruta, NivelEstrés.bajo),
    ...
    private ElementoDialogo CrearUsuario_18()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_18", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_19", ruta, NivelEstrés.muerto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_20", ruta, NivelEstrés.muerto),
