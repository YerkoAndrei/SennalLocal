...
public class RutaUsuario : InterfazRuta
{
    ...
    private ElementoDialogo CrearUsuario_2()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario2_10", ruta, NivelEstrés.alto),
    ...
    private ElementoDialogo CrearUsuario_3()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario3_4", ruta, NivelEstrés.gritando),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario3_5", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario3_6", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario3_12", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario3_13", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario3_14", ruta, NivelEstrés.bajo),
    ...
    private ElementoDialogo CrearUsuario_4()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_3", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_8", ruta, NivelEstrés.gritando),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_9", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_10", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_11", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_12", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_13", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_14", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario4_15", ruta, NivelEstrés.muerto),
    ...
    private ElementoDialogo CrearUsuario_5()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario5_0", ruta, NivelEstrés.alto),
    ...
    private ElementoDialogo CrearUsuario_6()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario6_1", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario6_10", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario6_11", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario6_12", ruta, NivelEstrés.muerto),
    ...
    public ElementoDialogo CrearUsuario_8()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario8_1", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario8_5", ruta, NivelEstrés.gritando),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario8_6", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario8_7", ruta, NivelEstrés.alto),
    ...
    private ElementoDialogo CrearUsuario_9()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario9_1", ruta),
    ...
    private ElementoDialogo CrearUsuario_12()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario12_6", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario12_16", ruta, NivelEstrés.alto),
    ...
    private ElementoDialogo CrearUsuario_14()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario14_3", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario14_18", ruta, NivelEstrés.gritando),
    ...
    private ElementoDialogo CrearUsuario_15()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_1", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_2", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_3", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_4", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_5", ruta, NivelEstrés.bajo),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_9", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_10", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_11", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_12", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_13", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_14", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario15_15", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_16", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_17", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_18", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_19", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_20", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_21", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_22", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_23", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_24", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_25", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_26", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_27", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_28", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_29", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_35", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario15_39", ruta, NivelEstrés.bajo),
    ...
    private ElementoDialogo CrearUsuario_16()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_9", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_10", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_11", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_12", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_13", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_14", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_15", ruta, NivelEstrés.alto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_16", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_17", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_18", ruta, NivelEstrés.alto),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_22", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_23", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_24", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario16_27", ruta),
            ...
            ElementoDialogo.CrearDiálogo(Personajes.computador, "usuario16_31", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_32", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_33", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario16_34", ruta),
    ...
    private ElementoDialogo CrearUsuario_17_1()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ElementoDialogo.CrearDiálogo(Personajes.computador, "usuario17_1_0", ruta, NivelEstrés.alto),
    ...
    private ElementoDialogo CrearUsuario_18()
    {
        var listaDiálogos = new List<ElementoDialogo>
        {
            ...
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_4", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_5", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_6", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.operador, "usuario18_7", ruta),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_8", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_9", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_10", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_11", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_12", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_13", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_14", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_15", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_16", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_17", ruta, NivelEstrés.bajo),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_18", ruta, NivelEstrés.muerto),
            ElementoDialogo.CrearDiálogo(Personajes.usuario, "usuario18_19", ruta, NivelEstrés.muerto),
